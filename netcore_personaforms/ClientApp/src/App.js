...
class App extends React.Component {
    ...
    onSuggestionsFetchRequested = ({ value }) => {
        ...
        fetch("api/knob/modelNumb/" + value)
            .then((res) => res.json())
            .then(
                (result) => {
    ...
    render() {
        ...
        const inputProps = {
            ...
            value,
            "aria-label": "find your model number",
                        ...
                        <div className='body'>
                            <form id='divWaterFilterForm' _lpchecked='1'>
                                ...
                                <div className='message'>
                                    <strong>
                                        <span className='thermador-mainheader'>
                                            Blue Knob Finder
                    </span>
                                    </strong>
                                    <br />
                                ...
                                <div className='search'>
                                    <div className='row'>
                                        <div className='columns medium-3' aria-label='Search'>
                                            <Autosuggest
                                                aria-label='Search'
                                                name='searchLabel'
                                                id='SKU'
                                                            ...
                                                            <tr>
                                                                ...
                                                                >
                                                                    <p style={{ textAlign: "left" }}>
                                                                        <strong>
                                                                            <span>Blue Knob Model Number:</span>
                                                                        </strong>{" "}
                                                                        {this.state.suggestionSelected.modelNum}
                                                                    </p>
                                                                    <br />
                                                                    <p style={{ textAlign: "left" }}>
                                                                        <strong>Blue Knob Part Number:</strong>{" "}
                                                                        {
                                                                            this.state.suggestionSelected
                                                                                .blueknobPartNum
                                                                        }
                                                                    ...
                                                                    <div>
                                                                        <img
                                                                            src='https://media3.bsh-group.com/Product_Shots/600x337/MCSA01081699_12005145_def.jpg'
                                                                            style={{ alignItems: "center" }}
                                                                            width='322'
                                                                            height='429'
                                                                            alt='Blue Knob Finder - Find Your Model Number'
                                                                        />
                                                                    </div>
                                                                    <br />
                                                                    <div>
                                                                        <a
                                                                            href={this.state.suggestionSelected.url}
                                                                            className='button button-submit'
                                                                            target='_blank'
                                                                        >
                                                                            Purchase Now
                                ...
                                <div>
                                    <img
                                        src='https://waterfilter.thermador.com/Public/img/19-THD-0893_LookForTHDSticker-Update2.jpg'
                                        alt='Blue Knob Finder - Find Your Model Number'
                                    />
                                </div>
                            </form>
